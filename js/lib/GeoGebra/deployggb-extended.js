  ...
  var fetchParametersFromTube = function(successCallback, materialsApiURL) {
    ...
    var api_request = {
      ...
      success = function() {
        ...
        for (
          i = 0;
          jsondata.responses && i < jsondata.responses.response.length;
          i++
        ) {
  ...
  applet.removeExistingApplet = function(appletParent, showScreenshot) {
    ...
    for (i = 0; i < appletParent.childNodes.length; i++) {
      ...
      if (appletParent.childNodes[i].className === "applet_screenshot") {
        ...
        (tag === "APPLET" || tag === "ARTICLE" || tag === "DIV") &&
...
GGBAppletUtils.makeModule = function(name, permutation) {
  function webModule() {
    ...
    webModule.__moduleBase =
      "https://cdn.geogebra.org/apps/latest/" + name + "/";
...
(function(window, document, undefined) {
    ...
    if (e) {
      ...
      f.onload = f.onreadystatechange = function() {
        if (
          ...
          (g = j),
            c && c(k),
            (f.onload = f.onreadystatechange = k),
  ...
  function A(a) {
    ...
    var b = k,
      ...
      e = k;
    a &&
      (a[1] !== k && a[1] && (b = parseInt(a[1], 10)),
      a[2] !== k && a[2] && (c = parseInt(a[2], 10)),
      a[3] !== k && a[3] && (d = parseInt(a[3], 10)),
      a[4] !== k &&
        a[4] &&
      ...
      a: {
        ...
        if (-1 != this.a.indexOf("Opera Mini/")) {
          ...
          if (
            ...
            ((g = F(this.a, /Version\/([\d\.]+)/, 1)), (h = A(g)), h.e !== k)
          ) {
            a = new B(
              "Opera",
              h,
  ...
  function ja(a) {
    ...
    /OPR\/[\d.]+/.test(a.a)
      ...
      ? (g = "Safari")
      : -1 != a.a.indexOf("AdobeAIR") && (g = "AdobeAIR");
    "BuiltinBrowser" == g
      ? (m = "Unknown")
      : "Silk" == g
      ? (m = F(a.a, /Silk\/([\d\._]+)/, 1))
      : "Chrome" == g
      ? (m = F(a.a, /(Chrome|CrMo|CriOS)\/([\d\.]+)/, 2))
      : -1 != a.a.indexOf("Version/")
      ? (m = F(a.a, /Version\/([\d\.\w]+)/, 1))
      : "AdobeAIR" == g
      ? (m = F(a.a, /AdobeAIR\/([\d\.]+)/, 1))
      : "Opera" == g
      ? (m = F(a.a, /OPR\/([\d.]+)/, 1))
      : "PhantomJS" == g && (m = F(a.a, /PhantomJS\/([\d.]+)/, 1));
    h = A(m);
    n =
      "AdobeAIR" == g
        ? 2 < h.e || (2 == h.e && 5 <= h.o)
  ...
  function oa(a, b, c, d, e, f, g, h) {
    ...
    for (var m in O)
      O.hasOwnProperty(m) &&
        (M(a, new H(O[m], I(this.q))), (this.F[O[m]] = a.s.offsetWidth));
    a.remove();
  }
  ...
  function qa(a) {
    var b = a.A.s.offsetWidth,
      c = a.B.s.offsetWidth;
    (b === a.F.serif && c === a.F["sans-serif"]) || (a.k.S && ra(a, b, c))
      ? da() - a.xa >= a.R
        ? a.k.S &&
          ra(a, b, c) &&
          (a.Y === k || a.Y.hasOwnProperty(a.q.getName()))
          ? P(a, a.U)
          : P(a, a.sa)
        : setTimeout(
            s(function() {
  ...
  R.prototype.ha = function(a) {
    var b = this.t;
    u(b.h, b.g.f(b.j, a.getName(), I(a).toString(), "loading"));
    ga(b.h, b.g.f(b.j, a.getName(), I(a).toString(), "active")) ||
      t(b.h, b.g.f(b.j, a.getName(), I(a).toString(), "inactive"));
    J(b, "fontinactive", a);
    ta(this);
  };
  function ta(a) {
    0 == --a.N &&
      ...
      (a.ba
        ? ((a = a.t),
          u(a.h, a.g.f(a.j, "loading")),
          u(a.h, a.g.f(a.j, "inactive")),
          t(a.h, a.g.f(a.j, "active")),
          J(a, "active"))
        : K(a.t));
  }
  function S(a, b, c) {
  ...
  S.prototype.load = function(a) {
    ...
    if (this.a.k.w) {
      ...
      for (c = e.length; f < c; f++)
        (d = e[f]), d.v(this.a, s(this.ta, this, d, b, a));
    } else K(b);
  };
        ...
        (d.__webfontfontdeckmodule__[c] = function(a, c) {
          for (var d = 0, m = c.fonts.length; d < m; ++d) {
            ...
            e.m.push(
              new H(
                n.name,
                la("font-weight:" + n.weight + ";font-style:" + n.style)
              )
            );
          }
          b(a);
    ...
    for (var a = this.p.length, b = 0; b < a; b++) {
      ...
      if (2 <= c.length) {
        ...
        3 == c.length &&
          ...
          (f = []),
          (c = !c ? f : c.split(",")),
          0 < c.length && (c = za[c[0]]) && (this.I[d] = c));
      }
  ...
  X.prototype.W = function(a) {
    for (
      var b = this.c,
        c = new wa(this.d.api, v(b), this.d.text),
        d = this.d.families,
        e = d.length,
        f = 0;
      f < e;
  ...
  Y.prototype.load = function(a) {
    w(
      this.c,
      v(this.c) + "//webfonts.fontslive.com/css/" + this.d.key + ".css"
    );
    for (var b = this.d.families, c = [], d = 0, e = b.length; d < e; d++)
      c.push.apply(c, Fa(b[d]));
    a(c);
  };
  function Fa(a) {
    var b = a.split(":");
